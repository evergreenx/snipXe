...
export default function SnipxOptions({ snipx }: { snipx: snpix }) {
  ...
  const [userSnipx, setUserSnipx] = useState<any>(snipx);
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          console.log(payload)
          setUserSnipx([...userSnipx, payload.new])}
      )
      .subscribe();
  ...
  }, [snipx, setUserSnipx, userSnipx]);


  console.log(userSnipx)
  console.log(snipx)
  return (
    <>
      {userSnipx &&
        userSnipx?.map((snip:any) => {
          ...
          return (
            <Link
              ...
              className="shadow-xl w-full lg:w-[318px] h-[174px] rounded-s-[16px]  p-3 rounded-tr-[4px] rounded-bl-[16px] rounded-br-[4px] rounded-e"
            >
              <div className="flex justify-between items-center">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-[170px] bg-white  left-2">
